...
The browser application suite contains 53 automated tests, including four new
regressions that exercise the actual platform property with zero, one and five
...
The production build was checked using Edge's iPhone SE device emulation in
