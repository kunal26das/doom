...
/** A view of immutable presentation state. No engine, storage, or audio access. */
@Composable
fun GameScreen(
    state: GameUiState,
    ...
    Box(
        ...
        if (bitmap != null) {
            Image(
                ...
                // Original 320x200 pixels are displayed at 4:3, with non-square pixels.
        ...
        // Render status after the game image so a late engine error remains visible.
