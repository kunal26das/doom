// Port of linuxdoom-1.10 m_random.c -- the vanilla pseudo-random LUT.
// Original code (C) 1993-1996 id Software, Inc., released under the GNU GPL v2.
@file:Suppress("FunctionName", "PropertyName", "unused", "MagicNumber", "ktlint")

package doom.engine

val rndtable: IntArray = intArrayOf(
...
/** Which one is deterministic? (vanilla comment) -- P_Random is the demo-sync one. */
fun P_Random(): Int {
