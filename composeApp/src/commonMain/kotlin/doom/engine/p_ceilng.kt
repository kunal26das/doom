...
const val lowerToFloor = 0
const val raiseToHighest = 1
const val lowerAndCrush = 2
const val crushAndRaise = 3
const val fastCrushAndRaise = 4
const val silentCrushAndRaise = 5

// From p_spec.h: ceiling_t
class ceiling_t : thinker_t() {
...
fun T_MoveCeiling(ceiling: ceiling_t) {
    val res: Int
...
//
fun EV_DoCeiling(line: line_t, type: Int): Int {
    var secnum: Int
    var rtn: Int
    var sec: sector_t
...
//
fun P_ActivateInStasisCeiling(line: line_t) {
    var i: Int
...
//
fun EV_CeilingCrushStop(line: line_t): Int {
    var i: Int
    var rtn: Int
