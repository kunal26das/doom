...
const val normal = 0
const val close30ThenOpen = 1
const val close = 2
const val open = 3
const val raiseIn5Mins = 4
const val blazeRaise = 5
const val blazeOpen = 6
const val blazeClose = 7

// From p_spec.h: vldoor_t
class vldoor_t : thinker_t() {
    var type = 0  // vldoor_e
...
const val VDOORSPEED = FRACUNIT * 2
...
fun EV_DoLockedDoor(line: line_t, type: Int, thing: mobj_t): Int {
    val p: player_t?
...
fun EV_DoDoor(line: line_t, type: Int): Int {
    var secnum: Int
    var rtn: Int
    var sec: sector_t
    var door: vldoor_t
...
//
private fun vldoor_direction_aliased_read(th: thinker_t): Int {
    return when (th) {
...
private fun vldoor_direction_aliased_write(th: thinker_t, value: Int) {
    when (th) {
...
//
fun EV_VerticalDoor(line: line_t, thing: mobj_t) {
    val player: player_t?
    val secnum: Int
    val sec: sector_t
    val door: vldoor_t
...
//
fun P_SpawnDoorRaiseIn5Mins(sec: sector_t, secnum: Int) {
    val door: vldoor_t
