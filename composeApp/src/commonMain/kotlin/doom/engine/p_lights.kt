...
// From p_spec.h: P_LIGHTS thinker structs.
class fireflicker_t : thinker_t() {
...
// for specials that spawn thinkers
//
fun P_SpawnStrobeFlash(sector: sector_t, fastOrSlow: Int, inSync: Int) {
    val flash: strobe_t
...
//
fun EV_LightTurnOn(line: line_t, bright: Int) {
    var bright = bright
    var temp: sector_t?
    var templine: line_t
