...
// lighttable_t** walllights --> one scalelight[] row of colormap offsets.
var walllights: IntArray = IntArray(0)

// C short* maskedtexturecol --> (array, base) pair; always points into
// openings: reads/writes are maskedtexturecol[maskedtexturecol_base + x].
...
//
private fun R_SnapshotClipArray(src: ShortArray, start: Int): Int {
...
//
fun R_RenderMaskedSegRange(ds: drawseg_t, x1: Int, x2: Int) {
...
//
fun R_StoreWallRange(start: Int, stop: Int) {
    val hyp: fixed_t
    var sineval: fixed_t
