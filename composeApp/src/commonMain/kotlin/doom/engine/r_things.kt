...
// lighttable_t** spritelights --> one scalelight[] row of colormap offsets.
var spritelights: IntArray = IntArray(0)

// constant arrays
//  used for psprite clipping and initializing clipping
val negonearray = ShortArray(SCREENWIDTH)
val screenheightarray = ShortArray(SCREENWIDTH)
...
val sprtemp = Array(29) { spriteframe_t() }
var maxframe = 0
...
private fun R_NameChar(name: String, i: Int): Int =
...
//
fun R_InitSpriteDefs(namelist: Array<String>) {
    var frame: Int
    var rotation: Int
...
// GAME FUNCTIONS
//
val vissprites = Array(MAXVISSPRITES) { vissprite_t() }
var vissprite_p = 0  // index into vissprites (C: vissprite_t*)
var newvissprite = 0
...
//
fun R_InitSprites(namelist: Array<String>) {
...
// R_NewVisSprite
//
val overflowsprite = vissprite_t()

fun R_NewVisSprite(): vissprite_t {
...
//
// C short* mfloorclip/mceilingclip --> (array, base) pairs: they can point at
// openings, screenheightarray, negonearray, or R_DrawSprite's clipbot/cliptop.
...
fun R_DrawMaskedColumn(column: ByteArray, ofs: Int) {
    var column_ofs = ofs
    var topscreen: Int
...
//
fun R_DrawVisSprite(vis: vissprite_t, x1: Int, x2: Int) {
...
//
fun R_ProjectSprite(thing: mobj_t) {
    var tr_x: fixed_t
    var tr_y: fixed_t
...
// R_DrawPSprite
//
fun R_DrawPSprite(psp: pspdef_t) {
    var tx: fixed_t
    var x1: Int
    var x2: Int
    val sprdef: spritedef_t
...
// R_SortVisSprites
//
val vsprsortedhead = vissprite_t()

fun R_SortVisSprites() {
    var i: Int
    val count: Int
    var ds: vissprite_t?
...
// R_DrawSprite
//
fun R_DrawSprite(spr: vissprite_t) {
