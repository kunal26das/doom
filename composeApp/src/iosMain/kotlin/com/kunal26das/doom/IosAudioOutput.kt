...
private class IosAudioOutput(private val render: (FloatArray) -> Unit) : AudioOutput {
    // Keep the entire graph alive for exactly the lifetime of this handle.
    ...
    fun start() {
        ...
        // Prime all buffers before playback can invoke a completion callback.
        ...
        try {
            ...
            player.scheduleBuffer(buffer) {
                try {
                    ...
                    // Stop the player outside its completion callback queue.
