...
internal var DoomEngineCore.demo_p
    get() = stateGameSession.demo_p
    set(value) { stateGameSession.demo_p = value }
...
internal var DoomEngineCore.key_right
    get() = stateGameSession.key_right
    set(value) { stateGameSession.key_right = value }
internal var DoomEngineCore.key_left
    get() = stateGameSession.key_left
    set(value) { stateGameSession.key_left = value }

internal var DoomEngineCore.key_up
    get() = stateGameSession.key_up
    set(value) { stateGameSession.key_up = value }
internal var DoomEngineCore.key_down
    get() = stateGameSession.key_down
    set(value) { stateGameSession.key_down = value }
internal var DoomEngineCore.key_strafeleft
    get() = stateGameSession.key_strafeleft
    set(value) { stateGameSession.key_strafeleft = value }
internal var DoomEngineCore.key_straferight
    get() = stateGameSession.key_straferight
    set(value) { stateGameSession.key_straferight = value }
internal var DoomEngineCore.key_fire
    get() = stateGameSession.key_fire
    set(value) { stateGameSession.key_fire = value }
internal var DoomEngineCore.key_use
    get() = stateGameSession.key_use
    set(value) { stateGameSession.key_use = value }
internal var DoomEngineCore.key_strafe
    get() = stateGameSession.key_strafe
    set(value) { stateGameSession.key_strafe = value }
internal var DoomEngineCore.key_speed
    get() = stateGameSession.key_speed
    set(value) { stateGameSession.key_speed = value }
...
internal fun DoomEngineCore.G_CmdChecksum(cmd: ticcmd_t): Int {
...
internal fun DoomEngineCore.I_BaseTiccmd(): ticcmd_t = emptycmd
...
//
internal fun DoomEngineCore.G_BuildTiccmd(cmd: ticcmd_t) {
...
// G_DoLoadLevel
//
internal fun DoomEngineCore.G_DoLoadLevel() {
    // Set the sky map.
...
//
internal fun DoomEngineCore.G_Responder(ev: event_t): Boolean {
...
//
internal fun DoomEngineCore.G_Ticker() {
...
//
internal fun DoomEngineCore.G_InitPlayer(player: Int) {
...
//
internal fun DoomEngineCore.G_PlayerFinishLevel(player: Int) {
    val p = players[player]
...
//
internal fun DoomEngineCore.G_PlayerReborn(player: Int) {
...
//
internal fun DoomEngineCore.G_CheckSpot(playernum: Int, mthing: mapthing_t): Boolean {
...
//
internal fun DoomEngineCore.G_DeathMatchSpawnPlayer(playernum: Int) {
...
// G_DoReborn
//
internal fun DoomEngineCore.G_DoReborn(playernum: Int) {
    if (!netgame) {
...
internal fun DoomEngineCore.G_ScreenShot() {
...
internal fun DoomEngineCore.G_ExitLevel() {
    secretexit = false
    gameaction = ga_completed
}

// Here's for the german edition.
internal fun DoomEngineCore.G_SecretExitLevel() {
...
internal fun DoomEngineCore.G_DoCompleted() {
    gameaction = ga_nothing
...
// G_WorldDone
//
internal fun DoomEngineCore.G_WorldDone() {
...
internal fun DoomEngineCore.G_DoWorldDone() {
    gamestate = GS_LEVEL
...
internal fun DoomEngineCore.G_LoadGame(name: String) {
    savename = name
...
internal fun DoomEngineCore.G_DoLoadGame() {
    gameaction = ga_nothing
...
//
internal fun DoomEngineCore.G_SaveGame(slot: Int, description: String) {
    savegameslot = slot
    savedescription = description
    sendsave = true
}

internal fun DoomEngineCore.G_DoSaveGame() {
    val name: String
...
internal var DoomEngineCore.d_skill
    get() = stateGameSession.d_skill
    set(value) { stateGameSession.d_skill = value }
internal var DoomEngineCore.d_episode
    get() = stateGameSession.d_episode
    set(value) { stateGameSession.d_episode = value }
internal var DoomEngineCore.d_map
    get() = stateGameSession.d_map
    set(value) { stateGameSession.d_map = value }

internal fun DoomEngineCore.G_DeferedInitNew(skill: Int, episode: Int, map: Int) {
    d_skill = skill
    d_episode = episode
    d_map = map
...
internal fun DoomEngineCore.G_DoNewGame() {
    demoplayback = false
    netdemo = false
    netgame = false
    deathmatch = 0
...
internal fun DoomEngineCore.G_InitNew(skill: Int, episode: Int, map: Int) {
    var skill = skill
    var episode = episode
    var map = map
...
internal fun DoomEngineCore.G_ReadDemoTiccmd(cmd: ticcmd_t) {
...
internal fun DoomEngineCore.G_WriteDemoTiccmd(cmd: ticcmd_t) {
...
// G_RecordDemo
//
internal fun DoomEngineCore.G_RecordDemo(name: String) {
    usergame = false
...
internal fun DoomEngineCore.G_BeginRecording() {
...
internal fun DoomEngineCore.G_DeferedPlayDemo(name: String) {
    defdemoname = name
    gameaction = ga_playdemo
}

internal fun DoomEngineCore.G_DoPlayDemo() {
    gameaction = ga_nothing
...
// G_TimeDemo
//
internal fun DoomEngineCore.G_TimeDemo(name: String) {
...
internal fun DoomEngineCore.G_CheckDemoStatus(): Boolean {
    if (timingdemo) {
