...
internal var DoomEngineCore.soundtarget: mobj_t?
    get() = stateMonsterBehavior.soundtarget
    set(value) { stateMonsterBehavior.soundtarget = value }

internal fun DoomEngineCore.P_RecursiveSound(sec: sector_t, soundblocks: Int) {
    var i: Int
    var check: line_t
    var other: sector_t?
...
//
internal fun DoomEngineCore.P_NoiseAlert(target: mobj_t, emmiter: mobj_t) {
    soundtarget = target
    validcount++
...
// P_CheckMeleeRange
//
internal fun DoomEngineCore.P_CheckMeleeRange(actor: mobj_t): Boolean {
    val pl: mobj_t
    val dist: fixed_t
...
// P_CheckMissileRange
//
internal fun DoomEngineCore.P_CheckMissileRange(actor: mobj_t): Boolean {
    var dist: fixed_t
...
internal fun DoomEngineCore.P_Move(actor: mobj_t): Boolean {
    val tryx: fixed_t
    val tryy: fixed_t
...
//
internal fun DoomEngineCore.P_TryWalk(actor: mobj_t): Boolean {
    if (!P_Move(actor)) {
        return false
    }
...
internal fun DoomEngineCore.P_NewChaseDir(actor: mobj_t) {
    val deltax: fixed_t
    val deltay: fixed_t
...
//
internal fun DoomEngineCore.P_LookForPlayers(actor: mobj_t, allaround: Boolean): Boolean {
    var c: Int
    val stop: Int
    val sector: sector_t
    ...
    while (true) {
        ...
        run {
            ...
            if (!allaround) {
                val an: angle_t = FixedGeometry.angleBetween(actor.x,
                    actor.y,
                    player.mo!!.x,
...
//
internal fun DoomEngineCore.A_KeenDie(mo: mobj_t) {
    var th: thinker_t
    val junk = line_t()
...
//
internal fun DoomEngineCore.A_Look(actor: mobj_t) {
    val targ: mobj_t?
...
//
internal fun DoomEngineCore.A_Chase(actor: mobj_t) {
    val delta: Int
...
// A_FaceTarget
//
internal fun DoomEngineCore.A_FaceTarget(actor: mobj_t) {
    if (actor.target == null)
        return
...
// A_PosAttack
//
internal fun DoomEngineCore.A_PosAttack(actor: mobj_t) {
    var angle: Int
    val damage: Int
    val slope: Int
...
internal fun DoomEngineCore.A_SPosAttack(actor: mobj_t) {
    var i: Int
    var angle: Int
    val bangle: Int
    var damage: Int
...
internal fun DoomEngineCore.A_CPosAttack(actor: mobj_t) {
    val angle: Int
    val bangle: Int
    val damage: Int
    val slope: Int
...
internal fun DoomEngineCore.A_CPosRefire(actor: mobj_t) {
...
internal fun DoomEngineCore.A_SpidRefire(actor: mobj_t) {
    // keep firing unless target got out of sight
    A_FaceTarget(actor)
...
internal fun DoomEngineCore.A_BspiAttack(actor: mobj_t) {
    if (actor.target == null)
        return
...
// A_TroopAttack
//
internal fun DoomEngineCore.A_TroopAttack(actor: mobj_t) {
    val damage: Int
...
internal fun DoomEngineCore.A_SargAttack(actor: mobj_t) {
    val damage: Int
...
internal fun DoomEngineCore.A_HeadAttack(actor: mobj_t) {
    val damage: Int
...
internal fun DoomEngineCore.A_CyberAttack(actor: mobj_t) {
    if (actor.target == null)
        return
...
internal fun DoomEngineCore.A_BruisAttack(actor: mobj_t) {
    val damage: Int
...
// A_SkelMissile
//
internal fun DoomEngineCore.A_SkelMissile(actor: mobj_t) {
    val mo: mobj_t
...
internal fun DoomEngineCore.A_Tracer(actor: mobj_t) {
    var exact: angle_t
    var dist: fixed_t
    val slope: fixed_t
    val dest: mobj_t?
...
internal fun DoomEngineCore.A_SkelWhoosh(actor: mobj_t) {
    if (actor.target == null)
        return
    A_FaceTarget(actor)
...
internal fun DoomEngineCore.A_SkelFist(actor: mobj_t) {
    val damage: Int
...
//
internal fun DoomEngineCore.A_VileChase(actor: mobj_t) {
    val xl: Int
    val xh: Int
    val yl: Int
    val yh: Int
    ...
    if (actor.movedir != DI_NODIR) {
        ...
        while (bx <= xh) {
            ...
            while (by <= yh) {
                ...
                // that canbe raised.
                if (!P_BlockThingsIterator(bx, by, { argument0 -> PIT_VileCheck(argument0) })) {
                    // got one!
...
// A_VileStart
//
internal fun DoomEngineCore.A_VileStart(actor: mobj_t) {
...
internal fun DoomEngineCore.A_StartFire(actor: mobj_t) {
    S_StartSound(actor, sfx_flamst)
    A_Fire(actor)
}

internal fun DoomEngineCore.A_FireCrackle(actor: mobj_t) {
    S_StartSound(actor, sfx_flame)
    A_Fire(actor)
}

internal fun DoomEngineCore.A_Fire(actor: mobj_t) {
    val dest: mobj_t?
...
// Spawn the hellfire
//
internal fun DoomEngineCore.A_VileTarget(actor: mobj_t) {
    val fog: mobj_t
...
// A_VileAttack
//
internal fun DoomEngineCore.A_VileAttack(actor: mobj_t) {
    val fire: mobj_t?
    val an: Int
...
internal val DoomEngineCore.FATSPREAD: angle_t
    get() = stateMonsterBehavior.FATSPREAD

internal fun DoomEngineCore.A_FatRaise(actor: mobj_t) {
    A_FaceTarget(actor)
    S_StartSound(actor, sfx_manatk)
}

internal fun DoomEngineCore.A_FatAttack1(actor: mobj_t) {
    val mo: mobj_t
    val an: Int
...
internal fun DoomEngineCore.A_FatAttack2(actor: mobj_t) {
    val mo: mobj_t
    val an: Int
...
internal fun DoomEngineCore.A_FatAttack3(actor: mobj_t) {
    var mo: mobj_t
    var an: Int
...
internal fun DoomEngineCore.A_SkullAttack(actor: mobj_t) {
    val dest: mobj_t
    val an: angle_t
    var dist: Int
...
//
internal fun DoomEngineCore.A_PainShootSkull(actor: mobj_t, angle: angle_t) {
    val x: fixed_t
    val y: fixed_t
    val z: fixed_t
...
// Spawn a lost soul and launch it at the target
//
internal fun DoomEngineCore.A_PainAttack(actor: mobj_t) {
    if (actor.target == null)
        return
...
internal fun DoomEngineCore.A_PainDie(actor: mobj_t) {
    A_Fall(actor)
...
internal fun DoomEngineCore.A_Scream(actor: mobj_t) {
    val sound: Int
...
internal fun DoomEngineCore.A_XScream(actor: mobj_t) {
    S_StartSound(actor, sfx_slop)
}

internal fun DoomEngineCore.A_Pain(actor: mobj_t) {
    if (actor.info!!.painsound != 0)
        S_StartSound(actor, actor.info!!.painsound)
}

internal fun DoomEngineCore.A_Fall(actor: mobj_t) {
...
// A_Explode
//
internal fun DoomEngineCore.A_Explode(thingy: mobj_t) {
...
//
internal fun DoomEngineCore.A_BossDeath(mo: mobj_t) {
    var th: thinker_t
    val junk = line_t()
    var i: Int
...
internal fun DoomEngineCore.A_Hoof(mo: mobj_t) {
    S_StartSound(mo, sfx_hoof)
    A_Chase(mo)
}

internal fun DoomEngineCore.A_Metal(mo: mobj_t) {
    S_StartSound(mo, sfx_metal)
    A_Chase(mo)
}

internal fun DoomEngineCore.A_BabyMetal(mo: mobj_t) {
    S_StartSound(mo, sfx_bspwlk)
    A_Chase(mo)
}

internal fun DoomEngineCore.A_OpenShotgun2(player: player_t, psp: pspdef_t) {
    S_StartSound(player.mo, sfx_dbopn)
}

internal fun DoomEngineCore.A_LoadShotgun2(player: player_t, psp: pspdef_t) {
    S_StartSound(player.mo, sfx_dbload)
}

internal fun DoomEngineCore.A_CloseShotgun2(player: player_t, psp: pspdef_t) {
...
internal fun DoomEngineCore.A_BrainAwake(mo: mobj_t) {
...
internal fun DoomEngineCore.A_BrainPain(mo: mobj_t) {
    S_StartSound(null, sfx_bospn)
}

internal fun DoomEngineCore.A_BrainScream(mo: mobj_t) {
    var x: Int
    var y: Int
    var z: Int
    var th: mobj_t
...
internal fun DoomEngineCore.A_BrainExplode(mo: mobj_t) {
    val x: Int
    val y: Int
    val z: Int
    val th: mobj_t
...
internal fun DoomEngineCore.A_BrainDie(mo: mobj_t) {
    G_ExitLevel()
}
...
internal fun DoomEngineCore.A_BrainSpit(mo: mobj_t) {
    val targ: mobj_t
    val newmobj: mobj_t
...
internal fun DoomEngineCore.A_SpawnSound(mo: mobj_t) {
    S_StartSound(mo, sfx_boscub)
    A_SpawnFly(mo)
}

internal fun DoomEngineCore.A_SpawnFly(mo: mobj_t) {
    val newmobj: mobj_t
    val fog: mobj_t
    val targ: mobj_t
    val r: Int
...
internal fun DoomEngineCore.A_PlayerScream(mo: mobj_t) {
    // Default death sound.
...
//
internal fun DoomEngineCore.P_RegisterEnemyActions() {
