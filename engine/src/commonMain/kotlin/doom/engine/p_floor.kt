...
internal const val lowerFloor = 0

// lower floor to lowest surrounding floor
internal const val lowerFloorToLowest = 1

// lower floor to highest surrounding floor VERY FAST
internal const val turboLower = 2

// raise floor to lowest surrounding CEILING
internal const val raiseFloor = 3

// raise floor to next highest surrounding floor
internal const val raiseFloorToNearest = 4

// raise floor to shortest height texture around it
internal const val raiseToTexture = 5

// lower floor to lowest surrounding floor
//  and change floorpic
internal const val lowerAndChange = 6

internal const val raiseFloor24 = 7
internal const val raiseFloor24AndChange = 8
internal const val raiseFloorCrush = 9

// raise to next highest floor, turbo-speed
internal const val raiseFloorTurbo = 10
internal const val donutRaise = 11
internal const val raiseFloor512 = 12

// From p_spec.h: stair_e
internal const val build8 = 0   // slowly build by 8
internal const val turbo16 = 1  // quickly build by 16
...
//
internal fun DoomEngineCore.T_MovePlane(
    sector: sector_t,
    speed: fixed_t,
    dest: fixed_t,
    crush: Boolean,
...
//
internal fun DoomEngineCore.T_MoveFloor(floor: floormove_t) {
    val res: Int
...
// HANDLE FLOOR TYPES
//
internal fun DoomEngineCore.EV_DoFloor(line: line_t, floortype: Int): Int {
    var secnum: Int
    var rtn: Int
    var i: Int
    var sec: sector_t
...
// BUILD A STAIRCASE!
//
internal fun DoomEngineCore.EV_BuildStairs(line: line_t, type: Int): Int {
    var secnum: Int
    var height: Int
    var i: Int
    var newsecnum: Int
