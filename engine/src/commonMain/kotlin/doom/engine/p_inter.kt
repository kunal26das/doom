...
//
internal fun DoomEngineCore.P_GiveAmmo(player: player_t, ammo: Int, num: Int): Boolean {
    var num = num
    val oldammo: Int
...
//
internal fun DoomEngineCore.P_GiveWeapon(player: player_t, weapon: Int, dropped: Boolean): Boolean {
...
//
internal fun DoomEngineCore.P_GiveBody(player: player_t, num: Int): Boolean {
...
//
internal fun DoomEngineCore.P_GiveArmor(player: player_t, armortype: Int): Boolean {
    val hits: Int
...
// P_GiveCard
//
internal fun DoomEngineCore.P_GiveCard(player: player_t, card: Int) {
...
// P_GivePower
//
internal fun DoomEngineCore.P_GivePower(player: player_t, power: Int /*powertype_t*/): Boolean {
...
// P_TouchSpecialThing
//
internal fun DoomEngineCore.P_TouchSpecialThing(special: mobj_t, toucher: mobj_t) {
    val player: player_t
    var i: Int
    val delta: fixed_t
    var sound: Int
...
// KillMobj
//
internal fun DoomEngineCore.P_KillMobj(source: mobj_t?, target: mobj_t) {
...
//
internal fun DoomEngineCore.P_DamageMobj(target: mobj_t, inflictor: mobj_t?, source: mobj_t?, damage: Int) {
    var damage = damage
