...
// P_SetPsprite
//
internal fun DoomEngineCore.P_SetPsprite(player: player_t, position: Int, stnum: Int) {
    var stnum = stnum
    val psp: pspdef_t
    var state: state_t
...
internal var DoomEngineCore.swingx: fixed_t
    get() = stateWeaponSprite.swingx
    set(value) { stateWeaponSprite.swingx = value }
internal var DoomEngineCore.swingy: fixed_t
    get() = stateWeaponSprite.swingy
    set(value) { stateWeaponSprite.swingy = value }

internal fun DoomEngineCore.P_CalcSwing(player: player_t) {
    val swing: fixed_t
    var angle: Int
...
// Uses player
//
internal fun DoomEngineCore.P_BringUpWeapon(player: player_t) {
    val newstate: Int
...
//
internal fun DoomEngineCore.P_CheckAmmo(player: player_t): Boolean {
...
// P_FireWeapon.
//
internal fun DoomEngineCore.P_FireWeapon(player: player_t) {
    val newstate: Int
...
//
internal fun DoomEngineCore.P_DropWeapon(player: player_t) {
    P_SetPsprite(player,
        ps_weapon,
        weaponinfo[player.readyweapon].downstate)
}
...
//
internal fun DoomEngineCore.A_WeaponReady(player: player_t, psp: pspdef_t) {
    val newstate: Int
    var angle: Int
...
//
internal fun DoomEngineCore.A_ReFire(player: player_t, psp: pspdef_t) {
    // check for fire
...
internal fun DoomEngineCore.A_CheckReload(player: player_t, psp: pspdef_t) {
    P_CheckAmmo(player)
    // (C: #if 0
...
//
internal fun DoomEngineCore.A_Lower(player: player_t, psp: pspdef_t) {
    psp.sy += LOWERSPEED
...
// A_Raise
//
internal fun DoomEngineCore.A_Raise(player: player_t, psp: pspdef_t) {
    val newstate: Int
...
// A_GunFlash
//
internal fun DoomEngineCore.A_GunFlash(player: player_t, psp: pspdef_t) {
...
// A_Punch
//
internal fun DoomEngineCore.A_Punch(player: player_t, psp: pspdef_t) {
    var angle: angle_t
    var damage: Int
    val slope: Int
...
// A_Saw
//
internal fun DoomEngineCore.A_Saw(player: player_t, psp: pspdef_t) {
    var angle: angle_t
    val damage: Int
    val slope: Int
...
// A_FireMissile
//
internal fun DoomEngineCore.A_FireMissile(player: player_t, psp: pspdef_t) {
...
// A_FireBFG
//
internal fun DoomEngineCore.A_FireBFG(player: player_t, psp: pspdef_t) {
...
// A_FirePlasma
//
internal fun DoomEngineCore.A_FirePlasma(player: player_t, psp: pspdef_t) {
    player.ammo[weaponinfo[player.readyweapon].ammo]--
...
internal var DoomEngineCore.bulletslope: fixed_t
    get() = stateWeaponSprite.bulletslope
    set(value) { stateWeaponSprite.bulletslope = value }

internal fun DoomEngineCore.P_BulletSlope(mo: mobj_t) {
    var an: angle_t
...
// P_GunShot
//
internal fun DoomEngineCore.P_GunShot(mo: mobj_t, accurate: Boolean) {
    var angle: angle_t
    val damage: Int
...
// A_FirePistol
//
internal fun DoomEngineCore.A_FirePistol(player: player_t, psp: pspdef_t) {
...
// A_FireShotgun
//
internal fun DoomEngineCore.A_FireShotgun(player: player_t, psp: pspdef_t) {
    var i: Int
...
// A_FireShotgun2
//
internal fun DoomEngineCore.A_FireShotgun2(player: player_t, psp: pspdef_t) {
    var i: Int
    var angle: angle_t
    var damage: Int
...
// A_FireCGun
//
internal fun DoomEngineCore.A_FireCGun(player: player_t, psp: pspdef_t) {
    S_StartSound(player.mo, sfx_pistol)
...
// ?
//
internal fun DoomEngineCore.A_Light0(player: player_t, psp: pspdef_t) {
    player.extralight = 0
}

internal fun DoomEngineCore.A_Light1(player: player_t, psp: pspdef_t) {
    player.extralight = 1
}

internal fun DoomEngineCore.A_Light2(player: player_t, psp: pspdef_t) {
    player.extralight = 2
}
...
//
internal fun DoomEngineCore.A_BFGSpray(mo: mobj_t) {
    var i: Int
    var j: Int
    var damage: Int
    var an: angle_t
...
// A_BFGsound
//
internal fun DoomEngineCore.A_BFGsound(player: player_t, psp: pspdef_t) {
...
//
internal fun DoomEngineCore.P_SetupPsprites(player: player_t) {
    var i: Int
...
//
internal fun DoomEngineCore.P_MovePsprites(player: player_t) {
    var i: Int
    var psp: pspdef_t
    var state: state_t?
...
//
internal fun DoomEngineCore.P_RegisterPsprActions() {
