...
internal var DoomEngineCore.save_p
    get() = statePSaveg.save_p
    set(value) { statePSaveg.save_p = value }
...
private val DoomEngineCore.saveg_restored_action: (thinker_t) -> Unit
    get() = statePSaveg.saveg_restored_action


// Endian-safe integer read/write functions

private fun DoomEngineCore.saveg_read8(): Int {
    val result = savebuffer.u8(save_p)
    save_p++
    return result
}

private fun DoomEngineCore.saveg_write8(value: Int) {
    savebuffer[save_p] = value.toByte()
    save_p++
}

private fun DoomEngineCore.saveg_read16(): Int {
    var result: Int
...
private fun DoomEngineCore.saveg_write16(value: Int) {
    saveg_write8(value and 0xff)
    saveg_write8((value shr 8) and 0xff)
}

private fun DoomEngineCore.saveg_read32(): Int {
    var result: Int
...
private fun DoomEngineCore.saveg_write32(value: Int) {
    saveg_write8(value and 0xff)
    saveg_write8((value shr 8) and 0xff)
...
private fun DoomEngineCore.saveg_readp(): Int {
    return saveg_read32()
}

private fun DoomEngineCore.saveg_writep(p: Any?) {
    saveg_write32(if (p != null) 1 else 0)
}

// Enum values are 32-bit integers.

private fun DoomEngineCore.saveg_read_enum(): Int = saveg_read32()

private fun DoomEngineCore.saveg_write_enum(value: Int) = saveg_write32(value)
...
private fun DoomEngineCore.saveg_read_mapthing_t(str: mapthing_t) {
    // short x;
    str.x = saveg_read16()
...
private fun DoomEngineCore.saveg_write_mapthing_t(str: mapthing_t?) {
...
private fun DoomEngineCore.saveg_read_actionf_t(str: thinker_t) {
    // actionf_p1 acp1;
    str.function = if (saveg_readp() != 0) saveg_restored_action else null
}

private fun DoomEngineCore.saveg_write_actionf_t(str: thinker_t) {
    // actionf_p1 acp1;
...
private fun DoomEngineCore.saveg_read_think_t(str: thinker_t) = saveg_read_actionf_t(str)

private fun DoomEngineCore.saveg_write_think_t(str: thinker_t) = saveg_write_actionf_t(str)

//
// thinker_t
//

private fun DoomEngineCore.saveg_read_thinker_t(str: thinker_t) {
...
private fun DoomEngineCore.saveg_write_thinker_t(str: thinker_t) {
    // struct thinker_s* prev;
...
private fun DoomEngineCore.saveg_read_mobj_t(str: mobj_t) {
    val pl: Int
...
private fun DoomEngineCore.saveg_write_mobj_t(str: mobj_t) {
    // thinker_t thinker;
...
private fun DoomEngineCore.saveg_read_ticcmd_t(str: ticcmd_t) {
...
private fun DoomEngineCore.saveg_write_ticcmd_t(str: ticcmd_t) {
    // signed char forwardmove;
...
private fun DoomEngineCore.saveg_read_pspdef_t(str: pspdef_t) {
    val state: Int
...
private fun DoomEngineCore.saveg_write_pspdef_t(str: pspdef_t) {
    // state_t* state;
    if (str.state != null) {
        saveg_write32(str.state!!.index)  // (state - states)
    } else {
...
private fun DoomEngineCore.saveg_read_player_t(str: player_t) {
    var i: Int
...
private fun DoomEngineCore.saveg_write_player_t(str: player_t) {
    var i: Int
...
private fun DoomEngineCore.saveg_read_ceiling_t(str: ceiling_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_ceiling_t(str: ceiling_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_vldoor_t(str: vldoor_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_vldoor_t(str: vldoor_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_floormove_t(str: floormove_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_floormove_t(str: floormove_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_plat_t(str: plat_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_plat_t(str: plat_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_lightflash_t(str: lightflash_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_lightflash_t(str: lightflash_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_strobe_t(str: strobe_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_strobe_t(str: strobe_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
private fun DoomEngineCore.saveg_read_glow_t(str: glow_t) {
    val sector: Int
...
private fun DoomEngineCore.saveg_write_glow_t(str: glow_t) {
    // thinker_t thinker;
    saveg_write_thinker_t(str)
...
// P_ArchivePlayers
//
internal fun DoomEngineCore.P_ArchivePlayers() {
    var i: Int
...
// P_UnArchivePlayers
//
internal fun DoomEngineCore.P_UnArchivePlayers() {
    var i: Int
...
// P_ArchiveWorld
//
internal fun DoomEngineCore.P_ArchiveWorld() {
    var i: Int
    var j: Int
    var si: side_t
...
// P_UnArchiveWorld
//
internal fun DoomEngineCore.P_UnArchiveWorld() {
    var i: Int
    var j: Int
    var si: side_t
...
// P_ArchiveThinkers
//
internal fun DoomEngineCore.P_ArchiveThinkers() {
    var th: thinker_t
...
// P_UnArchiveThinkers
//
internal fun DoomEngineCore.P_UnArchiveThinkers() {
    var tclass: Int
...
//
internal fun DoomEngineCore.P_ArchiveSpecials() {
    var th: thinker_t
    var i: Int
...
// P_UnArchiveSpecials
//
internal fun DoomEngineCore.P_UnArchiveSpecials() {
    var tclass: Int
