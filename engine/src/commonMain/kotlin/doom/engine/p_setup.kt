...
internal var DoomEngineCore.vertexes: Array<vertex_t>
...
internal var DoomEngineCore.segs: Array<seg_t>
...
internal var DoomEngineCore.sectors: Array<sector_t>
...
internal var DoomEngineCore.subsectors: Array<subsector_t>
...
internal var DoomEngineCore.nodes: Array<node_t>
...
internal var DoomEngineCore.lines: Array<line_t>
...
internal var DoomEngineCore.sides: Array<side_t>
...
internal var DoomEngineCore.deathmatch_p
    get() = stateWorldGeometry.deathmatch_p
    set(value) { stateWorldGeometry.deathmatch_p = value }
...
// P_LoadVertexes
//
internal fun DoomEngineCore.P_LoadVertexes(lump: Int) {
    val data: ByteArray
    var i: Int
...
// P_LoadSegs
//
internal fun DoomEngineCore.P_LoadSegs(lump: Int) {
    val data: ByteArray
    var i: Int
    var ldef: line_t
    var linedef: Int
...
// P_LoadSubsectors
//
internal fun DoomEngineCore.P_LoadSubsectors(lump: Int) {
    val data: ByteArray
    var i: Int
...
// P_LoadSectors
//
internal fun DoomEngineCore.P_LoadSectors(lump: Int) {
    val data: ByteArray
    var i: Int
...
// P_LoadNodes
//
internal fun DoomEngineCore.P_LoadNodes(lump: Int) {
    val data: ByteArray
    var i: Int
    var j: Int
    var k: Int
...
// P_LoadThings
//
internal fun DoomEngineCore.P_LoadThings(lump: Int) {
    val data: ByteArray
    var i: Int
    val numthings: Int
    var spawn: Boolean
...
//
internal fun DoomEngineCore.P_LoadLineDefs(lump: Int) {
    val data: ByteArray
    var i: Int
    var v1: vertex_t
    var v2: vertex_t
...
// P_LoadSideDefs
//
internal fun DoomEngineCore.P_LoadSideDefs(lump: Int) {
    val data: ByteArray
    var i: Int
...
// P_LoadBlockMap
//
internal fun DoomEngineCore.P_LoadBlockMap(lump: Int) {
    var i: Int
    var count: Int
...
//
internal fun DoomEngineCore.P_GroupLines() {
    var linebuffer: Int
    var i: Int
    var j: Int
    var total: Int
...
// P_SetupLevel
//
internal fun DoomEngineCore.P_SetupLevel(episode: Int, map: Int, playermask: Int, skill: Int) {
    var i: Int
    val lumpname: String
    val lumpnum: Int
...
// P_Init
//
internal fun DoomEngineCore.P_Init() {
    P_InitSwitchList()
    P_InitPicAnims()
