...
internal var DoomEngineCore.dc_colormap
    get() = stateRasterizer.dc_colormap
    set(value) { stateRasterizer.dc_colormap = value }
internal var DoomEngineCore.dc_x
    get() = stateRasterizer.dc_x
    set(value) { stateRasterizer.dc_x = value }
internal var DoomEngineCore.dc_yl
    get() = stateRasterizer.dc_yl
    set(value) { stateRasterizer.dc_yl = value }
internal var DoomEngineCore.dc_yh
    get() = stateRasterizer.dc_yh
    set(value) { stateRasterizer.dc_yh = value }
internal var DoomEngineCore.dc_iscale: fixed_t
    get() = stateRasterizer.dc_iscale
    set(value) { stateRasterizer.dc_iscale = value }
internal var DoomEngineCore.dc_texturemid: fixed_t
    get() = stateRasterizer.dc_texturemid
    set(value) { stateRasterizer.dc_texturemid = value }

internal var DoomEngineCore.dc_source: ByteArray
    get() = stateRasterizer.dc_source
    set(value) { stateRasterizer.dc_source = value }
internal var DoomEngineCore.dc_source_ofs
    get() = stateRasterizer.dc_source_ofs
    set(value) { stateRasterizer.dc_source_ofs = value }
...
//
internal fun DoomEngineCore.R_DrawColumn() {
    var count: Int
...
internal fun DoomEngineCore.R_DrawColumnLow() {
    var count: Int
    var dest: Int
    var dest2: Int
    var frac: fixed_t
...
//
internal fun DoomEngineCore.R_DrawFuzzColumn() {
    var count: Int
    var dest: Int
    var frac: fixed_t
    val fracstep: fixed_t
...
internal var DoomEngineCore.dc_translation
    get() = stateRasterizer.dc_translation
    set(value) { stateRasterizer.dc_translation = value }
...
internal fun DoomEngineCore.R_DrawTranslatedColumn() {
    var count: Int
    var dest: Int
    var frac: fixed_t
    val fracstep: fixed_t
...
//
internal fun DoomEngineCore.R_InitTranslationTables() {
...
internal var DoomEngineCore.ds_y
    get() = stateRasterizer.ds_y
    set(value) { stateRasterizer.ds_y = value }
internal var DoomEngineCore.ds_x1
    get() = stateRasterizer.ds_x1
    set(value) { stateRasterizer.ds_x1 = value }
internal var DoomEngineCore.ds_x2
    get() = stateRasterizer.ds_x2
    set(value) { stateRasterizer.ds_x2 = value }

internal var DoomEngineCore.ds_colormap
    get() = stateRasterizer.ds_colormap
    set(value) { stateRasterizer.ds_colormap = value }

internal var DoomEngineCore.ds_xfrac: fixed_t
    get() = stateRasterizer.ds_xfrac
    set(value) { stateRasterizer.ds_xfrac = value }
internal var DoomEngineCore.ds_yfrac: fixed_t
    get() = stateRasterizer.ds_yfrac
    set(value) { stateRasterizer.ds_yfrac = value }
internal var DoomEngineCore.ds_xstep: fixed_t
    get() = stateRasterizer.ds_xstep
    set(value) { stateRasterizer.ds_xstep = value }
internal var DoomEngineCore.ds_ystep: fixed_t
    get() = stateRasterizer.ds_ystep
    set(value) { stateRasterizer.ds_ystep = value }

internal var DoomEngineCore.ds_source: ByteArray
    get() = stateRasterizer.ds_source
    set(value) { stateRasterizer.ds_source = value }
internal var DoomEngineCore.ds_source_ofs
    get() = stateRasterizer.ds_source_ofs
    set(value) { stateRasterizer.ds_source_ofs = value }
...
internal fun DoomEngineCore.R_DrawSpan() {
    var xfrac: fixed_t
    var yfrac: fixed_t
    var dest: Int
    var count: Int
...
// Again..
//
internal fun DoomEngineCore.R_DrawSpanLow() {
    var xfrac: fixed_t
    var yfrac: fixed_t
    var dest: Int
    var count: Int
...
//  of a pixel to draw.
//
internal fun DoomEngineCore.R_InitBuffer(width: Int, height: Int) {
    // Handle resize,
...
//
internal fun DoomEngineCore.R_FillBackScreen() {
    val src: ByteArray
...
//
internal fun DoomEngineCore.R_VideoErase(ofs: Int, count: Int) {
    // LFB copy.
...
//
internal fun DoomEngineCore.R_DrawViewBorder() {
    val top: Int
    var side: Int
    var ofs: Int
