...
class FrameBuffersTest {
    ...
    private fun twoColumnPatch(): ByteArray = byteArrayOf(
        2, 0, 4, 0, 1, 0, 2, 0, // Width, height, left offset, top offset.
        16, 0, 0, 0, 28, 0, 0, 0, // Column offsets.
        0, 1, 0, -128, 0, // First column: one pixel at row 0.
        2, 2, 0, -1, 20, 0, -1, // Then two pixels at rows 2/3 and the sentinel.
        1, 2, 0, 30, 40, 0, -1, // Second column: rows 1/2 only.
    )
}
