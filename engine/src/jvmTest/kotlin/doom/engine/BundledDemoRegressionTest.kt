...
class BundledDemoRegressionTest {
    // Re-characterized for the bundled Ultimate DOOM v1.9 WAD using the DemoVerificationProcess
    // harness; the earlier baselines described the shareware WAD's demo lumps.
    // These protect this port's behavior; they do not establish parity with the DOS executable.
    @Test
    ...
    private fun verify(demo: String, tics: Int, hash: String) {
        ...
        val process = ProcessBuilder(
            java.absolutePath, "-cp", classpath, "doom.engine.DemoVerificationProcess", wad, demo,
